...
RACE_DURATION = 10  # Race duration (s)
...
allVehicleSprites = pygame.sprite.Group()  # All vehicle sprites
...
while running:
    ...
    if phase == 2:
        # Update all projectile and vessel sprites
        allProjectileSprites.update()
        allVesselSprites.update()
